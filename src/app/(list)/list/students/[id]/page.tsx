      ...
      <div className="flex p-4 flex-1 flex-col gap-4 md:flex-row">
        ...
        <div className=" w-full xl:w-2/3">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 flex gap-4 justify-between flex-wrap ">
              ...
              <div className=" w-full bg-white p-4 rounded-md flex gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
                <Clapperboard />
                <div className="">
                  <h1 className=" text-xl font-bold">2B</h1>
          ...
          <div className="mt-4 bg-white rounded-md p-4 h-[580px]">
            <h1 className=" text-xl font-extrabold">Student &apos; Schedule</h1>
            <BigCalendar />
          </div>
        </div>
        {/* Right */}
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
          <div className=" bg-white p-4 rounded-md">
            ...
            <div className=" mt-4 flex gap-4 flex-wrap text-sm text-gray-400">
              <Link className=" p-2 rounded-md bg-sky-300" href={"/"}>Student Lessons</Link>
              <Link className=" p-2 rounded-md bg-red-300" href={"/"}>Student Teachers</Link>
              <Link className=" p-2 rounded-md bg-yellow-300" href={"/"}>Student Exams</Link>
              <Link className=" p-2 rounded-md bg-pink-300" href={"/"}>Student Lessons</Link>
              <Link className=" p-2 rounded-md bg-green-300" href={"/"}>Student Assignments</Link>
              <Link className=" p-2 rounded-md bg-green-300" href={"/"}>Student Results</Link>
            </div>
          </div>
